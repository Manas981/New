...
forgotBtn.addEventListener("click", async () => {
  ...
  try {
    ...
    // Fallback mode so login works even if backend is unreachable in restricted environments.
...
loginBtn.addEventListener("click", async () => {
  ...
  // If backend OTP exists, verify via API; if local fallback OTP exists, verify locally.
  if (localOtp) {
    if (otp !== localOtp) {
